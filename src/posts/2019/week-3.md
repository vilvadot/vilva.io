...
This week has been very very light, real life mainly has gotten in the way once more and **I wasn’t as motivated as past weeks on the project**. So I took a light rest and focused in programming other things.
...
![](/images/2019/05/typeform-stats.png)

Screenshots are from the Spanish version, the English one only got 2 completions.

1.  **What is your profession?**

![](/images/2019/05/tp-bytevitae-1.png)

This was a multiple answer question BTW

The vast majority of people where **Programmers**. Not surprising since I sent it to developer communities.

* * *

**2\. ¿How often do you update your Currículum Vitae?**

![](/images/2019/05/tp-bytevitae-2-1.png)

I expected the main answer to be, “Only when switching jobs” but there is a surprisingly **good chunk of people who update their CVs multiple times a year**. This helps me decide on how to charge for the product, since Im battling between different options.
...
![](/images/2019/05/tp-bytevitae-3.png)

People prefer to **take care of the CVs themselves**. I think I must give them an amazing tool to do it 😉

* * *

**4\. How much did you pay for it? (Aprox.)**

![](/images/2019/05/tp-bytevitae-4.png)

Oh, my poor fellow designers working for free!

* * *

**5\. Have you ever used an online tool for creating your CV?**

![](/images/2019/05/tp-bytevitae-5-1.png)

This gives me a great insight. My hypothesis is:
...
*   [**Vizualize.me**](http://Visualize.me): Interesting tool, although it doesn’t fill the same gap as ByteVitae. They are trying to redefine how CVs are made. Im trying just to give a better tool for the existing status quo regarding CVs.
*   [**GitHub Résumé**](http://resume.github.io/?vilvadot): Interesting tool, basically what I want to do with the Github integration but kind of rudimentary output. Great inspiration nonetheless.
*   **Google Docs**

* * *

**7\. How was your experience using this tools?**

![](/images/2019/05/tp-bytevitae-6.png)

Most people's experience **is mediocre**. So I guess we I have a clear objective with ByteVitae, **make a 10/10 experience.**
...
As I promised last week I have been more active online, so this week I took some time to help some fellow [indie hackers](https://www.indiehackers.com/) and help them with feedback, opinions or just encouragement
...
[This tutorial](https://www.youtube.com/watch?v=QT3_zT97_1g) really helped me understand how the stripe library works:
...
*   I pair programmed [a Kata](http://katayuno-app.herokuapp.com/katas/17) with a couple of developer friends which are fresh out of the oven and preparing to land their first job!
